...
class FormLogin:
    ...
    def onSubmit(self, event=None):
        ...
        if C:
            ...
            self.parent.destroy()
            # Menampilkan pop-up login berhasil dengan warna hijau
            messagebox.showinfo("Berhasil", "Login Berhasil", icon='info')
        else:
            # Menampilkan pop-up login gagal dengan warna merah
